...
class BNN:
    ...
    def finalize(self, optimizer, optimizer_args=None, *args, **kwargs):
        ...
        with tf.variable_scope('calibration'):
            ...
            #reg_loss = tf.reduce_sum(self.recalibrator.losses)
            #self.cal_loss += reg_loss

            # TODO: consider putting inverse loss here
    ...
    def calibrate(self, inputs, targets,
        ...
        print('Shapes: inputs={}, mu={}, var={}, ys={}'.format(inputs.shape, all_mus.shape, all_vars.shape, all_ys.shape))
    ...
    def plot_calibration(self, inputs, targets, save_dir):
        ...
        for d in range(all_mus.shape[1]):
            ...
            ax1.set_title('Calibration Curve BNN (dim={}, t={})'.format(d, timestamp))
            ...
            ax2.hist(cdf_pred, range=(0, 1) , bins=10, label='Uncalibrated', histtype="step", lw=2)
            ax2.hist(cdf_pred_cal, range=(0, 1) , bins=10, label='Calibrated', histtype="step", lw=2)
    ...
    def save(self, savedir=None):
        ...
        # Save network parameters (including scalers) in a .mat file
        var_vals = {}
        for i, var_val in enumerate(self.sess.run(self.nonoptvars + self.optvars + self.cal_vars)):
